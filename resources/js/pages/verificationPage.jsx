  ...
  return (
    <div className="authContainer">
      <div className="form-container">
        ...
        <form className="form">
            <label><p className='forgotPasswordText'>Enter verification code</p></label>
            <InputCode/>
            <p className="resendLabel">
            If you didn't receive a code<button className="resendButton">Resend</button>
            </p>
            <ButtonLoginSignup
            label="Send"
          />
